...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F7] font-sans pb-40 text-slate-900">
          ...
          {transactions.map((t) => (
            <div key={t.id} className="bg-white p-4 rounded-[2rem] flex justify-between items-center shadow-sm border border-slate-50">
              <div className="flex items-center gap-4">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center text-xl ${t.category === 'Cashea' ? 'bg-[#007AFF]/10' : 'bg-slate-50'}`}>
      ...
      {showModal && (
        <div className="fixed inset-0 z-[60] flex items-end">
          ...
          <div className="relative w-full bg-white rounded-t-[3.5rem] p-8 max-w-md mx-auto shadow-2xl overflow-y-auto max-h-[90vh]">
